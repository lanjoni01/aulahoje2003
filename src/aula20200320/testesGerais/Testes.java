...
class Testes {
	...
	void testarComissaoDoVendedorComValorMinimo() {
		...
		double valorDaVenda = 5000.00;
		double percentualDeComissao = 10.00;
		double valorDaComissao = GerenciadorDeComissao.calcularComissaoComValorMinimo(valorMinimo, valorDaVenda,
		...
		valorDaVenda = 1000.00;
		percentualDeComissao = 3.00;
		valorDaComissao = GerenciadorDeComissao.calcularComissaoComValorMinimo(valorMinimo, valorDaVenda,
				percentualDeComissao);
	...
	void testarComissaoDoVendedorComFaixaDeValores() {
		...
		double valorDaVenda = 5000.00;
		double percentualDeComissao = 10.00;
		double valorDaComissao = GerenciadorDeComissao.calcularComissaoComFaixa(valorMinimo, valorMaximo, valorDaVenda,
				percentualDeComissao);
		...
		valorDaVenda = 1000.00;
		percentualDeComissao = 3.00;
		valorDaComissao = GerenciadorDeComissao.calcularComissaoComFaixa(valorMinimo, valorMaximo, valorDaVenda,
				percentualDeComissao);
